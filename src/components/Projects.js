...
const Projects = () => {
  ...
  const [done, setDone] = useState([{id: "0", name: "E-commerce", vid: vid1, desc: "Responsive e-commerce site for anime", delay: 500, liveSite: "https://splendid-granita-8f1e4f.netlify.app/", source: "https://github.com/Bill-1991/bill-commerce/tree/master", skills: ["Html", "Css", "Bootstrap", "Javascript", "React", "Node", "MySQL", "React-Router", "Anime API"], flip: false},
                {id: "1", name: "Insurances site", vid: "https://picsum.photos/200/300", desc: "A site for a company called Worthinsurance. Descriptions and packets of every insurance the company offers", delay: 1000, liveSite: "https://worthinsurance.netlify.app", source: "https://github.com/Bill-1991/insurances-site/tree/main/src", skills: ["Html", "Css", "Javscript", "React"], flip: false},
                {id: "2", name: "Multistep form", vid: "https://picsum.photos/200/300", desc: "Multistep Form. (Not fully constructed in rsponsiveness. A project by Frontmentor!)", delay: 1500, liveSite: "https://warm-sfogliatella-1b0cc2.netlify.app/", source: "https://github.com/Bill-1991/multistep-form-frontmentor/tree/master/src", skills: ["Html", "Css", "Javscript", "React"], flip: false},
                {id: "3", name: "Tic Tac Toe", vid: "https://picsum.photos/200/300", desc: "Tic Tac Toe minigame. (Not fully constructed. There's no live site on this only the source code. VScom mode only does random moves)", delay: 1500, livesite: "", source: "https://github.com/Bill-1991/Tic-tac-toe", skills: ["Html", "Css", "Javscript"], flip: false}])  
              ...
              <div style={{color: "white"}}>
                ...
                <div className="skills" style={{color: "black", width: "100%"}}>
                  <Row style={{width: "90%", position: "relative", left: "5%"}}>
                    {project.skills.map(skill => <Col key={skill}><p>{skill}</p></Col>)}
                  </Row>
                </div>
              </div>
              <div className='d-grid' style={{display: "flex", gap: "4%", justifyContent: "center"}}>
                {
                project.liveSite ? 
                  <a href={project.liveSite} target="_blank" rel="noreferrer">
                    <Button className='w-100'>Live</Button>
                  </a>
                :
                  undefined
                }
