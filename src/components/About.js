...
const About = (props) => {
  ...
  return (
    ...
    <div className='intro'>
      ...
      <p>Thank you for checking my portfolio.The source code of it is <strong><a href="https://github.com/Bill-1991/portfolio/branches" target="_blank" rel="noreferrer"><p>here</p></a></strong></p>
  </div>
  </Row>
  )
}
